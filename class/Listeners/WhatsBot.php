<?php
	...
	class WhatsBotListener extends WhatsBotListenerCore
	{
		...
		{
			$this->Parser->ParseTextMessage(new WhatsApp\TextMessage($Me, $From, $From, $ID, $Type, $Time, $Name, $Text));
		}

		public function onGetGroupMessage($Me, $From, $User, $ID, $Type, $Time, $Name, $Text)
		{
			$this->Parser->ParseTextMessage(new WhatsApp\TextMessage($Me, $From, $User, $ID, $Type, $Time, $Name, $Text));
		}
		...
		public function onGetAudio($Me, $From, $ID, $Type, $Time, $Name, $Size, $URL, $File, $MIME, $Hash, $Duration, $Codec, $User = null)
		{
			...
			$this->Parser->ParseMediaMessage(new WhatsApp\AudioMessage($Me, $From, $User, $ID, $Type, $Time, $Name, $URL, $File, $Size, $MIME, $Hash, $Duration, $Codec));
		}

		public function onGetImage($Me, $From, $ID, $Type, $Time, $Name, $Size, $URL, $File, $MIME, $Hash, $Width, $Height, $Preview, $Caption)
		{
			$this->Parser->ParseMediaMessage(new WhatsApp\ImageMessage($Me, $From, $From, $ID, $Type, $Time, $Name, $URL, $File, $Size, $MIME, $Hash, $Width, $Height, $Preview, $Caption));
		}

		public function onGetGroupImage($Me, $From, $User, $ID, $Type, $Time, $Name, $Size, $URL, $File, $MIME, $Hash, $Width, $Height, $Preview, $Caption)
		{
			$this->Parser->ParseMediaMessage(new WhatsApp\ImageMessage($Me, $From, $User, $ID, $Type, $Time, $Name, $URL, $File, $Size, $MIME, $Hash, $Width, $Height, $Preview, $Caption));
		}
		...
		public function onGetLocation($Me, $From, $ID, $Type, $Time, $Name, $Author, $Longitude, $Latitude, $URL, $Preview, $User)
		{
			...
			$this->Parser->ParseMediaMessage(new WhatsApp\LocationMessage($Me, $From, $User, $ID, $Type, $Time, $Name, $URL, $Author, $Longitude, $Latitude, $Preview));
		}
		...
		{
			$this->Parser->ParseMediaMessage(new WhatsApp\VideoMessage($Me, $From, $From, $ID, $Type, $Time, $Name, $URL, $File, $Size, $MIME, $Hash, $Duration, $Preview, $Caption, $Width, $Height, $FPS, $VCodec, $VBitRate, $ACodec, $ABitRate, $ASampleFrequency, $ASampleFormat));
		}
		...
		{
			$this->Parser->ParseMediaMessage(new WhatsApp\VideoMessage($Me, $From, $User, $ID, $Type, $Time, $Name, $URL, $File, $Size, $MIME, $Hash, $Duration, $Duration, $Preview, $Caption, $Width, $Height, $FPS, $VCodec, $VBitRate, $ACodec, $ABitRate, $ASampleFrequency, $ASampleFormat));
		}
		...
		public function onGetvCard($Me, $From, $ID, $Type, $Time, $Name, $vCardName, $vCard, $User)
		{
			...
			$this->Parser->ParseMediaMessage(new WhatsApp\vCardMessage($Me, $From, $User, $ID, $Type, $Time, $Name, $vCardName, $vCard));
		}
